...
#SBATCH --job-name=retrieve_bm25_zeroshot_deepseek
...
export WORKSPACE=$SSD_MOUNT/benchmark/retrieve_zeroshot_deepseek
mkdir -p $WORKSPACE

cd benchmark

#Prepare the queries.
python3 -m sources.retrieve_zeroshot_deepseek \
